...
$team_box_data = array(
    ...
    'fields' => array(
        ...
        array(
            'name' => '',
            'desc' => '',
            'id' => 'coll_member_image_button',
            'type' => 'button',
            'std' => 'Browse'
        ),
        array(
            'name' => __('Position', 'framework'),
            'desc' => __('Enter the team member position', 'framework'),
            'id' => 'coll_member_position',
            "type" => "text",
            'std' => ''
        ),
    )
...
{
    global $team_box_data;

    add_meta_box($team_box_data['id'], $team_box_data['title'], 'show_team_box_data', $team_box_data['page'], $team_box_data['context'], $team_box_data['priority']);


}


function show_team_box_data()
{
    global $team_box_data, $post;
    ...
    foreach ($team_box_data['fields'] as $field) {
