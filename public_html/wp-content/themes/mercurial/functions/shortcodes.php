...
function coll_portfolio($atts, $content = null)
{
    ...
    // first item (all)
    $output .= '<li><a href="#" class="button link" data-filter="*">' . __('All', 'framework') . '</a></li>';
...
//    $content .= '<h4>Send A Message</h4>';
    ...
    $content .= '<p>';
    $content .= '<input class="field" name="name" type="text" id="name" placeholder="' . __('NAME', 'framework') . '"/>';
//    $content .= '<label class="error" for="name">Name *</label>';
    $content .= '</p>';
    $content .= '<p>';
    $content .= '<input class="field" name="email" type="text" id="email" placeholder="' . __('EMAIL', 'framework') . '"/>';
//    $content .= '<label for="email">E-mail address *</label>';
    $content .= '</p>';
    $content .= '<p><textarea class="field" rows="15" cols="" name="message" placeholder="' . _x('MESSAGE', 'noun', 'framework') . '"></textarea></p>';
    $content .= '<p><input type="submit" value="send" class="button" id="contact-submit" /></p>';
    $content .= '</form>';
