function format_tweets(tweetdata) {
    ...
    for (var i = 0; i < tweetdata.length; i++) {
        ...
        statusHTML.push('<span class="tweet-text">' + status + '</span>');
        //statusHTML.push('<li><span>' + status + '</span> <a href="http://twitter.com/' + username + '/statuses/' + tweetdata[i].id_str + '">' + relative_time(tweetdata[i].created_at) + '</a></li>');
    }
